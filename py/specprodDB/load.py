...
def main():
    ...
    loaders = {'exposures': [{'filepaths': os.path.join(options.datapath, 'spectro', 'redux', specprod, f'tiles-{specprod}.{tiles_type}'),
               ...
               #
               'photometry': [{'filepaths': glob.glob(os.path.join(os.environ['SCRATCH'], f'{schemamodule.schemaname}.photometry.*.fits')),
               ...
               'target': [{'filepaths': glob.glob(os.path.join(os.environ['SCRATCH'], f'{schemamodule.schemaname}.target.*.fits')),
                           # 'filepaths': target_files,
                           'tcls': schemamodule.Target,
                           'hdu': 'TARGETPHOT',
                           'chunksize': chunksize
                           }],
               'redshift': [{'filepaths': glob.glob(os.path.join(os.environ['SCRATCH'], f'{schemamodule.schemaname}.ztile.*.fits')),
